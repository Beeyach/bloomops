...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 165: (a, b, c) => {
      ...
      c.r(f), c.d(f, { config: () => bC, middleware: () => bE });
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = Symbol.for("__cloudflare-context__");
      function bu() {
      ...
      async function bw() {
        ...
        if (bv()) {
          var b2;
          let a11 = await bx();
          return b2 = a11, globalThis[bt] = b2, a11;
        }
        throw Error(by);
      }
      async function bx(a10) {
        let { getPlatformProxy: b2 } = await import(`${"__wrangler".replaceAll("_", "")}`), c2 = a10?.environment ?? process.env.NEXT_DEV_WRANGLER_ENV, { env: d2, cf: e2, ctx: f2 } = await b2({ ...a10, envFiles: [], environment: c2 });
        return { env: d2, cf: e2, ctx: f2 };
      }
      let by = '\n\nERROR: `getCloudflareContext` has been called without having called `initOpenNextCloudflareForDev` from the Next.js config file.\nYou should update your Next.js config file as shown below:\n\n   ```\n   // next.config.mjs\n\n   import { initOpenNextCloudflareForDev } from "@opennextjs/cloudflare";\n\n   initOpenNextCloudflareForDev();\n\n   const nextConfig = { ... };\n   export default nextConfig;\n   ```\n\n';
      async function bz(a10, b2) {
        let c2 = await crypto.subtle.importKey("raw", new TextEncoder().encode(a10), { name: "HMAC", hash: "SHA-256" }, false, ["sign"]);
        var d2 = new Uint8Array(await crypto.subtle.sign("HMAC", c2, new TextEncoder().encode(b2)));
        let e2 = "";
        for (let a11 = 0; a11 < d2.length; a11++) e2 += String.fromCharCode(d2[a11]);
        return btoa(e2).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
      }
      let bA = Date.UTC(2026, 7, 22);
      async function bB(a10, b2, c2 = Date.now()) {
        if (!b2 || "string" != typeof b2 || !b2.includes(".")) return null;
        let d2 = function(a11) {
          let b3 = a11 && a11.LTB_SESSION_SECRET;
          return b3 || (!function() {
            try {
              return "undefined" != typeof process && process.env && true;
            } catch {
              return false;
            }
          }() ? "dev-only-session-secret-not-for-prod" : null);
        }(a10);
        if (!d2) return null;
        let [e2, f2] = b2.split(".");
        if (!e2 || !f2 || !function(a11, b3) {
          if (a11.length !== b3.length) return false;
          let c3 = 0;
          for (let d3 = 0; d3 < a11.length; d3++) c3 |= a11.charCodeAt(d3) ^ b3.charCodeAt(d3);
          return 0 === c3;
        }(f2, await bz(d2, e2))) return null;
        try {
          let a11 = JSON.parse(function(a12) {
            let b4 = a12.length % 4 ? "=".repeat(4 - a12.length % 4) : "";
            return atob(a12.replace(/-/g, "+").replace(/_/g, "/") + b4);
          }(e2));
          if (!a11 || !a11.w) return null;
          let b3 = Number(a11.iat) || 0;
          if (0 === b3) {
            if (c2 >= bA) return null;
          } else if (c2 / 1e3 - b3 > 2592e3) return null;
          return { workspace: String(a11.w), role: "admin" === a11.r ? "admin" : "user" };
        } catch {
          return null;
        }
      }
      let bC = { matcher: ["/((?!_next/|favicon.ico|fonts/|guide/).*)"] };
      function bD(a10) {
        return a10.headers.set("Cache-Control", "no-cache, must-revalidate"), a10;
      }
      async function bE(a10) {
        let { pathname: b2 } = a10.nextUrl;
        if ("/gate" === b2 || b2.startsWith("/api/auth") || "GET" === a10.method && (/^\/p\/[0-9a-f]{32,64}\/?$/.test(b2) || /^\/api\/public\/[0-9a-f]{32,64}\/?$/.test(b2))) return bD(S.next());
        if ("/api/public/video-view" === b2 && ("POST" === a10.method || "OPTIONS" === a10.method) || "/api/cron/drain" === b2 && ("POST" === a10.method || "PUT" === a10.method) && a10.headers.get("x-cron-secret") || "/api/gmail/push" === b2 && "POST" === a10.method && (a10.headers.get("authorization") || "").startsWith("Bearer ")) return S.next();
        let c2 = function() {
          try {
            let { env: a11 } = function(a12 = { async: false }) {
              return a12.async ? bw() : function() {
                let a13 = bu();
                if (a13) return a13;
        ...
        }(), d2 = a10.cookies.get("ltb_session");
        if (d2 ? await bB(c2, d2.value) : null) return bD(S.next());
        if (b2.startsWith("/api/")) return S.json({ error: "Not authenticated. Enter your access code." }, { status: 401 });
        let e2 = a10.nextUrl.clone();
        return e2.pathname = "/gate", e2.search = "", S.redirect(e2);
      }
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bF = { ...f }, bG = bF.middleware || bF.default, bH = "/middleware";
      ...
      function bI(a10) {
        return bg({ ...a10, page: bH, handler: async (...a11) => {
          try {
            return await bG(...a11);
          } catch (e2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/|favicon.ico|fonts\\/|guide\\/).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.js", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/runner/work/bloomtrack-pro/bloomtrack-pro", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 1, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.js", "turbopack": { "root": "/home/runner/work/bloomtrack-pro/bloomtrack-pro" } };
var BuildId = "WwEwCOwpp54Q-Tv5734z8";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/gate", "regex": "^/gate(?:/)?$", "routeKeys": {}, "namedRegex": "^/gate(?:/)?$" }], "dynamic": [{ "page": "/api/clients/[id]", "regex": "^/api/clients/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/clients/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/leads/[id]", "regex": "^/api/leads/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/leads/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/leads/[id]/promote", "regex": "^/api/leads/([^/]+?)/promote(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/leads/(?<nxtPid>[^/]+?)/promote(?:/)?$" }, { "page": "/api/library/[id]", "regex": "^/api/library/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/library/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/pages/[id]", "regex": "^/api/pages/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/pages/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/pages/[id]/share", "regex": "^/api/pages/([^/]+?)/share(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/pages/(?<nxtPid>[^/]+?)/share(?:/)?$" }, { "page": "/api/prospects/[id]", "regex": "^/api/prospects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/prospects/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/prospects/[id]/contacts", "regex": "^/api/prospects/([^/]+?)/contacts(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/prospects/(?<nxtPid>[^/]+?)/contacts(?:/)?$" }, { "page": "/api/prospects/[id]/conversation", "regex": "^/api/prospects/([^/]+?)/conversation(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/prospects/(?<nxtPid>[^/]+?)/conversation(?:/)?$" }, { "page": "/api/prospects/[id]/outreach", "regex": "^/api/prospects/([^/]+?)/outreach(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/prospects/(?<nxtPid>[^/]+?)/outreach(?:/)?$" }, { "page": "/api/public/[token]", "regex": "^/api/public/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/api/public/(?<nxtPtoken>[^/]+?)(?:/)?$" }, { "page": "/p/[token]", "regex": "^/p/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtoken": "nxtPtoken" }, "namedRegex": "^/p/(?<nxtPtoken>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "27982d5ff5b00bf2cd44aa49e3b965c0", "previewModeSigningKey": "efcb50c269de3960ed5f585f6f4b3235ca4ba554562bf06c7d1a8b97c8b4fa13", "previewModeEncryptionKey": "9a9b08b4793c723912554131da3c5e47600a7fafc5331926b9ff14a7dfe09534" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/|favicon.ico|fonts\\/|guide\\/).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!_next/|favicon.ico|fonts/|guide/).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "WwEwCOwpp54Q-Tv5734z8", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "h719ymYBT8KcED9J7mGt2kXzF9K9nAe2e8vHA+3Iu10=", "__NEXT_PREVIEW_MODE_ID": "27982d5ff5b00bf2cd44aa49e3b965c0", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "efcb50c269de3960ed5f585f6f4b3235ca4ba554562bf06c7d1a8b97c8b4fa13", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "9a9b08b4793c723912554131da3c5e47600a7fafc5331926b9ff14a7dfe09534" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/ai-usage/route": "/api/ai-usage", "/api/audit-video/precheck/route": "/api/audit-video/precheck", "/api/audit-video/thumb/route": "/api/audit-video/thumb", "/api/auth/route": "/api/auth", "/api/backlog/route": "/api/backlog", "/api/backfill/route": "/api/backfill", "/api/baseline/route": "/api/baseline", "/api/clients/route": "/api/clients", "/api/contact-discovery/route": "/api/contact-discovery", "/api/credits/route": "/api/credits", "/api/audit-video/route": "/api/audit-video", "/api/daily-log/route": "/api/daily-log", "/api/economics/route": "/api/economics", "/api/embed/resolve/route": "/api/embed/resolve", "/api/clients/[id]/route": "/api/clients/[id]", "/api/cron/drain/route": "/api/cron/drain", "/api/gmail/callback/route": "/api/gmail/callback", "/api/gmail/connect/route": "/api/gmail/connect", "/api/gmail/push/route": "/api/gmail/push", "/api/gmail/status/route": "/api/gmail/status", "/api/held/route": "/api/held", "/api/import/apify/route": "/api/import/apify", "/api/jobs/retry/route": "/api/jobs/retry", "/api/ai/route": "/api/ai", "/api/leads/route": "/api/leads", "/api/legacy-drafts/route": "/api/legacy-drafts", "/api/library/route": "/api/library", "/api/leads/[id]/promote/route": "/api/leads/[id]/promote", "/api/library/[id]/route": "/api/library/[id]", "/api/followup-preview/route": "/api/followup-preview", "/api/outreach/sent/route": "/api/outreach/sent", "/api/pages/[id]/route": "/api/pages/[id]", "/api/pages/[id]/share/route": "/api/pages/[id]/share", "/api/leads/[id]/route": "/api/leads/[id]", "/api/prospects/[id]/contacts/route": "/api/prospects/[id]/contacts", "/api/prospects/[id]/conversation/route": "/api/prospects/[id]/conversation", "/api/outreach/route": "/api/outreach", "/api/prospects/[id]/outreach/route": "/api/prospects/[id]/outreach", "/api/limits/route": "/api/limits", "/api/prospects/import/route": "/api/prospects/import", "/api/prospects/[id]/route": "/api/prospects/[id]", "/api/public/[token]/route": "/api/public/[token]", "/api/public/video-view/route": "/api/public/video-view", "/api/queue/route": "/api/queue", "/api/replies/ingest/route": "/api/replies/ingest", "/api/scan/enrich/route": "/api/scan/enrich", "/api/pages/route": "/api/pages", "/api/prospects/export/route": "/api/prospects/export", "/api/scan/import/route": "/api/scan/import", "/api/scanner-runs/route": "/api/scanner-runs", "/api/prospects/route": "/api/prospects", "/api/send-shadow/route": "/api/send-shadow", "/api/targets/route": "/api/targets", "/api/today/route": "/api/today", "/api/trash/route": "/api/trash", "/api/vet/route": "/api/vet", "/api/visual-evidence/route": "/api/visual-evidence", "/api/settings/route": "/api/settings", "/api/voice/route": "/api/voice", "/api/voice-cache/route": "/api/voice-cache", "/api/system-health/route": "/api/system-health", "/api/scan/route": "/api/scan", "/gate/page": "/gate", "/p/[token]/page": "/p/[token]", "/page": "/" };
