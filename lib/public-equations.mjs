...
export function renderEquationsForPublic(bodyHtml, {maxEquations=Infinity,maxSourceLength=Infinity}={}) {
  ...
  return html.replace(EQUATION_BLOCK, (whole, tagAttrs) => {
    ...
    if(latex.length>maxSourceLength||renderedCount>=maxEquations)return whole;
    renderedCount++;
