...
export function blueprintResponse(result, status = 200) {
  ...
  if (result.reason === 'not_eligible') return json({ error: 'A GHL build is available only for an empty planned project with an enabled GHL blueprint.', restartAllowed: true }, 409);
