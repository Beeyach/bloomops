...
export function profileDraftValue(value,scope,now=Date.now()){
 ...
 return {version:1,id:value.id,...scope,...(creating?{creationRequestId:value.creationRequestId}:{}),section:value.section,revision:value.revision,updatedAt:value.updatedAt,fields,before,sources,sourceBefore};
}
