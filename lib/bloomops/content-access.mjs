...
export function contentClientReadCondition(actor) {
  ...
  return and(eq(c.productionArea, 'social'), isNull(c.adsProjectId), eq(c.workspaceId, actor.workspaceId), liveProjectActor(actor), previewClientCondition(actor, c.clientId), eq(c.visibility, 'client'),
