...
export function outreachBlockers({profile,sender,draft,recipientChecked}){
 ...
 if(['recipient','timeZone','subject','intro'].some(k=>!draft[k]))reasons.push('Complete the recipient, timezone, subject and introduction.');
 if(draft.followUp3&&!draft.followUp2)reasons.push('Add the first follow-up before the second follow-up.');
