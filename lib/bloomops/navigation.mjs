...
export const INTERNAL_NAV = [
  ...
  },
  {
    ...
    availability: 'later',
    mobile: false,
    purpose: 'Projects, milestones, and actions across every client and department.',
  },
  {
    key: 'social',
    label: 'Social',
    ...
    availability: 'later',
    mobile: false,
    purpose: 'Content production, from idea to published, with client approvals inside each item.',
  },
  {
    key: 'ads',
    label: 'Ads',
  ...
  },
  {
    ...
    availability: 'later',
    mobile: false,
    purpose: 'GHL, Kajabi, funnels, automations, and integrations, through QA to launch.',
  },
  {
    key: 'pages',
    label: 'Pages',
