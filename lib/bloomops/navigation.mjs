...
export const PROSPECTING_NAV = [
  ...
  {key:'results',label:'Results',href:'/prospecting/results',group:'delivery',mobile:true},
  {key:'skills',label:'Skills Library',href:'/prospecting/skills',group:'delivery',mobile:false},
];
