...
export async function activateClient(
  db,
  { actor, clientId, mailer, appUrl, workspaceName, inviterName = null, now = new Date(), retryOnly = false, sendInvitation = true, activationGuard = sql`1`, expectedPlanHash = null },
) {
