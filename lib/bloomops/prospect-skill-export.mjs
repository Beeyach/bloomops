...
export async function exportProspectSkill(db,actor,input,now=new Date()){
 ...
 csvSource:data.csvSource||null,offerApproval:{status:'not_provided',source:null,price:null,claims:[]},outreachState:{status:'not_provided',sendingAuthorized:false}};
