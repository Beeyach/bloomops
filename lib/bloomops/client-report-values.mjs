...
export function reportInput(input,template){
 if(!template||!exactKeys(input,['title','periodStart','periodEnd','timezone','channel','accountLabel','scopeLabel','commentary','metrics',...CLIENT_NARRATIVE_FIELDS]))return {error:'Unsupported report fields or template version.'};
 ...
 return {value:{...input,...narrative,title:input.title.trim(),accountLabel:input.accountLabel.trim(),scopeLabel:input.scopeLabel.trim(),commentary:input.commentary.trim(),metrics}};
}
