...
export const prospects = sqliteTable('bloomops_prospects', {
  ...
  index('bloomops_prospects_list_idx').on(t.workspaceId,t.businessName,t.id),index('bloomops_prospects_fit_idx').on(t.workspaceId,t.fit,t.businessName,t.id),
...
export const BLOOMOPS_TABLES = [
  prospectConversions,
  workspaces, workspaceCreations, workspacePages, workspacePageTrees, workspacePageLocations, workspacePageSettings, workspacePageGrants, pageCommentThreads, pageComments, prospects, prospectFieldSources, prospectImportReceipts, prospectImportRows, prospectSkillResults, prospectSenders, prospectOutreachDrafts, prospectOutreachApprovals, prospectDeliveries, prospectDeliveryIdentities, prospectReplyStates, prospectReplyObservations, prospectDiscoveryStates, prospectDiscoveryRuns, prospectDiscoveryTargets, prospectRecoveryCollections, prospectRecoveryMessages, prospectMonitoringCheckpoints, prospectReportChecks, prospectReportTargets, prospectGoogleConnections, prospectGoogleAttempts, user, session, account, verification,
