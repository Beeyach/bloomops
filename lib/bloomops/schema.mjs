...
// shapes below match `@better-auth/cli generate` output for that version. The
// nullable `issuer` column is added ahead of Better Auth's documented account
// model so a later upgrade does not need an ALTER. No auth behaviour exists
// yet; these tables are the foundation A3 builds on.
