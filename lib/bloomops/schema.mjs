...
export const BLOOMOPS_TABLES = [
  ...
  assets, assetLinks, assetUploadAttempts, contentAssetLinks, contentReviewRevisions, contentApprovalRounds,
  templates, templateVersions, serviceTypeBlueprintBindings,
