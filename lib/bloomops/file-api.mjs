...
export const fileAccess = (req, fileId, action = 'file.view', options = {}) => requireAuthorized(req,
...
export async function readFileUpload(req, { retry = false } = {}) {
  ...
  const checked = validateFileInput(input, { retry });
