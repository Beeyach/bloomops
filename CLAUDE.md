...
Departments are organizational views, not separate data silos.
...
Templates must be versionable or snapshot their relevant definition at instantiation.
...
This project is implemented incrementally across multiple Claude Code sessions.
