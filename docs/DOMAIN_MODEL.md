...
Platforms, calendars, recording/File subjects, formal approvals, revision-history screens, Content portal, comments, notifications and templates remain future Release C work. No `content_platforms` table exists in C1.
