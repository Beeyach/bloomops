...
- Recovered WSLg has recurring compositor crashes. Software-rendered application browser79 passed; standalone actionability probes were inconsistent. Preserve failed receipts and use actual completed runs for claims.
