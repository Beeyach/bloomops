...
| Reusable Work and Pages / Operations | Reusable Work is merged in PR87 as5325819, tree-equivalent to validated candidatebf6607b. Full7323/7323 and feature CI35053689479 pass (Work21/native22/browser23; report browser149, notifications60/preferences23). Staging35055162518 and disposable remote-D135055162489 pass; migration0052 brings staging to53. Genuine internal/portal actors passed26 live checks, including saved authoring, exact date/dependency preview, real generation/destinations, retry, second event, immutable prior jobs, revision, retirement/restore and portal denial, with zero runtime errors. Ready-event35055150872 also passes. Pages record context is implemented on feat/pages-record-links-20260916 from5325819; its contract is in phases/N4.md. Source3a80ab6 passes full7337/7337 and the completed build. Harnesscc954b0 passes20 built-Worker checks with zero runtime errors, unchanged build hashes and6 matching served assets; only replacement-state selectors differ from the built source. Native Page checks15 and retained Work checks22 pass, including populated upgrades, concurrent saves, zero-row writes and rollback. Portal context uses canonical client labels and authorized Project-summary anchors. Migration0053 adds the optional context relationship and its valid Project parent key. Local zero-to-current54 and unchanged second pass, actionlint and diff checks pass; PR88 first CI35058129985 passed full7337 but exposed a concurrent archive/read false-revocation state in reporting browser acceptance. Reproduction and correction18cf7a6 read report headers/metrics/comparison selection in one D1 snapshot and retain a final current-authority check. Corrected local full7339/7339, reporting60/native45/browser151 and completed build pass; remote revalidation and staging are next. Page-template work is separately in progress on feat/page-templates-20260916 and is not included in PR88. Saved-version capture/review, catalogue, persisted preview, canonical private Page creation, retirement/restoration and retry/conflict UI are implemented. Focused API/schema/hierarchy/context checks62 and disposable nativeD1 checks22 pass; full-suite/build/browser and integration remain pending. Migration0054 is additive and preserves operational template kinds. Existing P4A–I and N1F editor/recovery remain complete; implement canonical Client/Project links, then Page templates without duplicating them. Remaining release-F workload/department/finance/template-management acceptance stays open until verified against its contract. |
