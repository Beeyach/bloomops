...
| Reporting completion (current) | Reviewed generic CSV merged in PR82 as38df2ea; full7269/feature CI, staging deployment35015205770, remote-D1 and ready-event validation passed. Live CSV review/save/reopen for both templates recorded on PR82 at2026-09-15T19:47Z; persisted-data confirmation follows storage recovery. Missing-default onboarding setup is in PR83 with local full7273, native5 and browser79 passing; normal remote run35023835855 is in progress. Successor feat/reporting-published-versions-20260915 now implements immutable publication/revision/withdrawal, client-only current-version routes, separate public narrative and matching PDF generation; focused59/native29 pass, integration verification pending. Remaining: compatible comparisons/charts and new-period reuse; explicit publication, immutable versions, revisions/withdrawal; supported portal access and matching PDF. CLIENT_REPORTING.md and phases/N3.md own details. |
