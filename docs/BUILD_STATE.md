...
| Reporting completion | Reviewed CSV(PR82), supported onboarding/portal activation(PR83), immutable publication/revision/withdrawal/client access/PDF and empty new-period reuse(PR84), archive/private restore(PR85), and compatible saved comparisons/charts(PR86) are merged and staging verified. Current main/staging1973e2f has52 domain migrations. PR86 candidate ff30302 has the same tree as merged1973e2f; full7301/7301 and feature CI35047921174 pass (report58/native45/browser149, notifications60/preferences23). Staging35049258412, disposable remote-D135049258348 and ready-event35049255092 pass. Genuine separate internal/portal actors passed19 comparison checks; actual three-page GHL/social PDFs show correct -32/-17 differences and exclude private source notes. Archive16 and publication31 live checks remain retained. No provider, custom-metric designer, scheduled sending or PERF3 acceptance is implied. Consolidated stabilization remains ahead. |
