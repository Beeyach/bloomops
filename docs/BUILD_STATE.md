...
| Reusable Work and Pages / Operations | Reusable Work is merged in PR87 as5325819, tree-equivalent to validated candidatebf6607b. Full7323/7323 and feature CI35053689479 pass (Work21/native22/browser23; report browser149, notifications60/preferences23). Staging35055162518 and disposable remote-D135055162489 pass; migration0052 brings staging to53. Genuine internal/portal actors passed26 live checks, including saved authoring, exact date/dependency preview, real generation/destinations, retry, second event, immutable prior jobs, revision, retirement/restore and portal denial, with zero runtime errors. Ready-event35055150872 also passes. Pages record context is merged in PR88 asdd11062, tree-equivalent to validated candidatebe43ae9. Corrected full7339/7339 and feature CI35059987518 pass, including the real concurrent report archive/read correction (report60/native45/browser151, Page13/native15/browser20). Staging35061564915 passed; migration0053 brings staging to54. Genuine internal/portal actors passed15 live checks: saved context, unchanged writing, Project→linked Page navigation, narrow layout, independently authorized portal Project-summary link and revocation. Temporary Project visibility and Page grant were restored. Disposable remote-D135061564859 failed with a network fetch during unchanged inherited migration053; cleanup succeeded and its single infrastructure retry passed. Ready-event35061561822 also passed both jobs, with full7339/7339. Page templates are separately implemented on feat/page-templates-20260916 from this integrated main: saved-writing capture/review, immutable versions, catalogue/preview, canonical private Page creation, retirement/restoration and retry/conflict UI. Source585518f passes full7355/7355 and completed build; final harness8963224 passes23 built-Worker checks with zero runtime errors, unchanged artifact hashes and9 matching served assets. Only harness refinements and a tree-preserving main merge follow that built source. Focused62, nativeD122, zero-to-current55 with unchanged second pass, actionlint and diff checks pass. Migration0054 adds Page-specific immutable snapshots/provenance without changing operational template kinds. PR89 first feature run35062022003 passed application checks through Work browser, then a Page-context assertion counted the separate template catalogue link. Harness-only437a3a5 now requires the denied context region to be absent and its access-denial message visible;20 local checks pass on the combined Team build with identical Page inputs. Corrected remote run35063271184 and staging remain pending. Existing P4A–I and N1F editor/recovery remain complete; preserve canonical Client/Project links and finish Page-template integration without duplicating them. Remaining release-F workload/department/finance/template-management acceptance stays open until verified against its contract. |
| Team workload / Operations | New F1 Action workload is implemented separately on feat/team-action-workload-20260916, following the agreed Release-F scope. Current canonical Actions grouped by assignee, unassigned/inactive responsibility, Work date/dependency semantics, bounded summaries/detail and current permission filtering. Team/Work navigation and real Action destinations are connected. Sourceb30fde5 passes focused workload/access/projection63, nativeD19, full7362/7362, completed build and13 real built-Worker checks with zero runtime errors and9 matching served assets. Browser setup uses supported Client/Service/Project/Action writers and real internal/portal invitation authentication; it verifies assignment→summary→canonical destination→completion, narrow layout, Action-only authority and revocation. Remote/staging acceptance remain pending. No migration, capacity scoring or directory permission expansion. This does not claim Social production, Finance or remaining Operations complete; contract phases/F.md. |
