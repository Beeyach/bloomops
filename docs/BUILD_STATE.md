...
| Reporting completion (current) | Reviewed generic CSV merged in PR82 as38df2ea; full7269/feature CI, staging deployment35015205770, remote-D1 and ready-event validation passed. Live CSV review/save/reopen for both templates recorded on PR82 at2026-09-15T19:47Z; persisted-data confirmation follows storage recovery. Missing-default onboarding setup merged in PR83 as62ae623 after remote full7273/feature success (35023835855); staging35025730152 and remote-D135025730095 passed. Genuine controlled portal identity accepted its contact invitation and opened its synthetic Project; supported setup is usable. Successor feat/reporting-published-versions-20260915 now implements immutable publication/revision/withdrawal, client-only current-version routes, separate public narrative and matching PDF generation; PR84 holds publication/PDF: sourcea98b429 full7281, focused40, native29, completed build and102 reporting browser checks pass; final harness673eeb3 uses an isolated optional WSL rasterizer workaround. Normal CI35042522578 is running after correcting premature keyboard activation. New-period setup through the existing writer is integrated into PR84's working branch (the owned successor branch is preserved); focused43/native31/full7284 and completed build pass. Browser found a premature PDF click before hydration; control readiness and explicit held-script regressions now cover both publication and PDF. Combined source69ad2ba passes full7284/7284 and completed build;119 reporting browser checks pass with zero runtime errors,8 served assets matched and unchanged artifacts. Cross-Client denial is verified through the streamed not-found screen, absent editor and API404. Remote673eeb3 validation35042522578 passed both jobs; integrated candidate d8b22b4 is running normal CI35044170862. Archive/restore on feat/reporting-archive-20260916 implements active/archived lists, read-only archived drafts and private restore requiring a fresh explicit publication. Migration0050 is additive. Focused68 and native39 (including populated publication upgrade) pass; source0e42d7c full7291/7291, completed stamped build and135 built-Worker reporting checks pass with zero runtime errors; fresh/repeated local migrations pass. Archive release remains pending its normal PR/CI/staging sequence. Publication/new-period merged in PR84 as79f74b3 on tree-equivalent green full7284/feature CI35044170862; staging35045440644 and remote-D135045440594 passed. Genuine two-actor publication acceptance31 checks, both new-period creation flows and inspected live PDFs pass at79f74b3; QA membership restored, useful synthetic reports retained. Ready-event validation35045436166 also passed. Archive PR85 has normal CI35045481101. Compatible comparisons/charts are implemented on the owned successor branch; focused77 and native45 pass, full/build/browser verification is next. Only compatible prior publications are selectable; counts remain unverified and no growth percentage or invented trend is added. Remaining: their integration and revision-bound staging acceptance. CLIENT_REPORTING.md and phases/N3.md own details. |
