...
Current phase: **D2 — GHL build interface and HTTP boundary is in progress; preparation/generation backend is closed.** Status: [BUILD_STATE.md](BUILD_STATE.md). Current contract: [D2_INTERFACE.md](phases/D2_INTERFACE.md). Backend: [D2_GENERATION.md](phases/D2_GENERATION.md). Earlier storage/compiler contracts remain under `phases/`. Performance remains closed.
