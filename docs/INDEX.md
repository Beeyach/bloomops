...
- `RELEASE_E.md` — Ads boundaries and E1–E5 sequence; `phases/E2.md` and `phases/E2B.md` route internal creative implementation after accepted E2A
...
Release E — Ads is underway; E1 and E2A are closed. The [E2B internal creative interface contract](phases/E2B.md) is implemented and locally verified and independently reviewed; publication gates are pending.
