...
Current phase: **D2 — explicit GHL setup interface is in progress; generation HTTP/UI is closed.** Status: [BUILD_STATE.md](BUILD_STATE.md). Contract: [D2_SETUP_INTERFACE.md](phases/D2_SETUP_INTERFACE.md). Generation UI: [D2_INTERFACE.md](phases/D2_INTERFACE.md). Earlier backend/storage/compiler contracts remain under `phases/`. Performance remains closed.
