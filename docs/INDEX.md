...
- `RELEASE_E.md` — Ads boundaries and E1–E5 sequence; `phases/E2.md` and `phases/E2B.md` record accepted internal creative production; `phases/E3.md` and `phases/E3A.md` route approval/media work; foundation acceptance is in progress
...
Release E — Ads is underway; E1 and E2 are closed on verified `09de9d6`. The [E3](phases/E3.md) and [E3A](phases/E3A.md) contracts are prepared; E3A evidence foundation acceptance and release gates are the first unfinished task. See [RELEASE_E](RELEASE_E.md) and [BUILD_STATE](BUILD_STATE.md).
