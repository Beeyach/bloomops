...
Current owner priority: integrated agreed-product completion, tracked in [BUILD_STATE](BUILD_STATE.md). [Reporting](phases/N3.md) is merged and staging verified through1973e2f; [N4 reusable Work and Page links](phases/N4.md) are integrated; Page templates (PR89) and [F1 Team Action workload](phases/F.md) are merged and staging verified throughbafd6e0. F2 Department work is the current bounded implementation, locally verified and awaiting remote/staging gates. N2E and PR79 remain closed. Preserve E3B and paused Prospecting work.
