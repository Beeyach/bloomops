...
try {
  ...
  await client.page.reload();check('linked Client Home has the sole narrow approval link',await client.page.locator(`a[href="${portalPath}"]`).count()===1&&await client.page.locator('a[href="/social"],a[href="/portal/content"],a[href="/portal/approvals"]').count()===0);
