...
try{
 ...
 await reload();check('Old copies are collapsed and do not replace saved cells automatically',await page.locator('.bo-sheet-recovery').evaluate(e=>!e.open)&&await choice('Platform').inputValue()==='WordPress');await restore();
