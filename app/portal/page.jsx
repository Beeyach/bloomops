...
export default async function PortalHomePage() {
  ...
  return <PortalHome workspaceName={access.workspace.name} user={access.user} recordings={recordings} milestones={milestones} deliverables={deliverables} files={files} clients={clients.map(client => ({ ...client, projects: projects.filter(project => project.clientId === client.id) }))} />;
}
