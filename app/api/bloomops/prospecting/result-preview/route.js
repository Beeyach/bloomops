...
import {previewSkillResult,SKILL_RESULT_LIMIT} from '@/lib/bloomops/prospect-skill-results.mjs';
...
export const POST=withApiErrors(async req=>{
 ...
 const result=await previewSkillResult(access.db,access.actor,await readStructuredBody(req,{maxBytes:SKILL_RESULT_LIMIT}));
