...
export default async function ProspectsPage({searchParams}){
 ...
 return <div className="bo-prospect-page"><PageHeader title="Prospects" subtitle="People and businesses you’re considering." actions={<><Button href="/prospecting/import" icon="eye">Review source</Button><Button href="/prospecting/new" variant="primary" icon="plus">New prospect</Button></>}/>
