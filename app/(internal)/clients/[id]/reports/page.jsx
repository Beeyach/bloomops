...
export default async function Reports({params,searchParams}){
 ...
 return <div className="bo-report"><PageHeader title={`Reports for ${view.client.name}`} description="Private manual drafts. Only authorized internal team members can read these reports."/>
