...
const palettes=[['#eeeafb','#a99bff','#ffe98a'],['#fff0e9','#ff82c8','#ffe98a'],['#e9f7f4','#56bfa1','#ffb49c'],['#eaf5ff','#6ec8ff','#ffe98a']];
function variantFor(seed){let hash=0;for(const char of String(seed||'garden'))hash=(Math.imul(hash,31)+char.codePointAt(0))>>>0;return hash%palettes.length;}
function Garden({variant}){
