...
export default function PortalContentNav({hasContent=true,hasPages=false,hasReports=false}) {
  ...
  return <nav className="bo-portal-content-nav" aria-label="Client portal">
    ...
    {hasReports&&<a href="/portal/reports" aria-current={path?.startsWith('/portal/reports')?'page':undefined}>Reports</a>}
  </nav>;
}
